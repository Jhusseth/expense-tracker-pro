...
export default function StatsCard({ label, value, type, isDark = true }: StatsCardProps) {
  ...
  return (
    <div className={`rounded-xl p-6 border transition hover:scale-105 ${isDark ? 'bg-gray-800 border-gray-700 hover:border-gray-600' : 'bg-white border-gray-200 hover:border-gray-300'}`}>
